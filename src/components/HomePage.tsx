...
<a href="tel:+212610818391" className="glass rounded-2xl p-6 text-center card-hover group">
            ...
            <a href="https://instagram.com/Salahquadora" target="_blank" rel="noopener noreferrer" className="glass rounded-2xl p-6 text-center card-hover group">
              ...
              <p className="text-dune text-sm mt-1">@Salahquadora</p>
        ...
        <div className="mx-auto max-w-7xl px-6">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-4 text-xs text-muted">
            ...
            <div className="flex items-center gap-6">
              ...
              <a href="https://instagram.com/Salahquadora" target="_blank" rel="noopener noreferrer" className="hover:text-dune transition-colors">Instagram</a>
